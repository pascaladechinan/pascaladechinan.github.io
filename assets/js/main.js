...
/*========= Menu hidden ============*/
/* validation if constante exists */
if(navClose){
...
tabs.forEach(tab =>{
  tab.addEventListener('click', () =>{
    ...
    tab.forEach(tab =>{
      tab.classList.remove('qualificatin__active')
    })
...
function scrollUp(){
  ...
  // when the scroll is higher than 500 viewport height, add the show scroll class to the tag 
